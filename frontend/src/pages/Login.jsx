    ...
    if (user == null)
        return (
            <>
                ...
                <div className="bg-dark shadow-md border border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 dark:bg-gray-900 dark:border-gray-900 mx-auto w-fit mt-8">
                    <form className="space-y-6" onSubmit={(e) => {
                        e.preventDefault();
                        handleLogin(uname.current.value, pwd.current.value)
                    }}
                    >
                        <div className="bg-dark shadow-md border border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 dark:bg-gray-900 dark:border-gray-900">
